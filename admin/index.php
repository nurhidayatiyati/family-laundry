...
<div class="container">
    <div class="alert alert-info text-center">
        <h4 style="margin-bottom: 0px">SELAMAT DATANG DI <b>LAUNDRY NURHIDAYATI</b></h4>
    </div>
                ...
                <div class="col-md-3">
                    <div class="panel" style="background-color:Lightpink;">
                        <div class="panel-heading">
                            <h1>
                                <i class="glyphicon ">
                                <img style="width:50px; height:50px;" src="1.png" alt="">
                                </i>
                ...
                <div class="col-md-3">
                    <div class="panel" style="background-color:aqua;">
                        <div class="panel-heading">
                            <h1>
                                <i class="glyphicon">
                                <img style="width:50px; height:50px;" src="03.png" alt="">
                                </i>
                                <span class="pull-right">
                ...
                <div class="col-md-3">
                    <div class="panel" style="background-color:aquamarine;">
                        <div class="panel-heading">
                            <h1>
                                <i class="glyphicon ">
                                <img style="width:50px; height:50px;" src="5.png" alt="">
                                </i>
                                <span class="pull-right">
